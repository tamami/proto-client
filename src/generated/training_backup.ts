...
/**
 * @generated from protobuf message aikibo.CourseReqById
 */
export interface CourseReqById {
    /**
...
class CourseReqById$Type extends MessageType<CourseReqById> {
    constructor() {
        super("aikibo.CourseReqById", [
            { no: 1, name: "id", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<CourseReqById>): CourseReqById {
        const message = { id: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CourseReqById>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CourseReqById): CourseReqById {
    ...
    internalBinaryWrite(message: CourseReqById, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 id = 1; */
        if (message.id !== 0)
...
/**
 * @generated MessageType for protobuf message aikibo.CourseReqById
 */
export const CourseReqById = new CourseReqById$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class Student_PhoneNumber$Type extends MessageType<Student_PhoneNumber> {
    ...
    create(value?: PartialMessage<Student_PhoneNumber>): Student_PhoneNumber {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Student_PhoneNumber): Student_PhoneNumber {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Student_PhoneNumber, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string number = 1; */
        if (message.number !== "")
